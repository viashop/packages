...
/**
 * Class VerificarEnderecoEmailCadastrado
 * @package Email\Notification\Controller\Verification
 */
class VerificarEnderecoEmailCadastrado extends DadosEmail
{

    public function content()
    {

        $url_link = sprintf("%s/public/email-confirmar/", VIALOJA_APP, $this->hash );

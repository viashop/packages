...
/**
 * Class VerificarEnderecoEmailAutoLogin
 * @package Email\Notification\Controller\Verification
 */
class VerificarEnderecoEmailAutoLogin extends DadosEmail
{

    public function content()
    {

        $link = sprintf("http://admin.%s/public/email-confirmar/%s", VIALOJA_BASE, $this->hash);
                    ...
                    <table width=\"600\" bgcolor=\"#f7f7f7\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\" class=\"table\">
                        ...
                        <tr>
                            ...
                            <td width=\"560\" valign=\"top\" align=\"left\" class=\"inside\" style=\"font-size: 13px; color: #525252; text-align: left; font-family: Helvetica, Arial, sans-serif; vertical-align: top;\">
                                ...
                                <!--[if mso]>
                                <v:roundrect xmlns:v=\"urn:schemas-microsoft-com:vml\" xmlns:w=\"urn:schemas-microsoft-com:office:word\" href=\"{$link}\" style=\"height:40px;v-text-anchor:middle;width:300px;\" arcsize=\"10%\" stroke=\"f\" fillcolor=\"#8CB82B\" class=\"button\">
                                <w:anchorlock/>

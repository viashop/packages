 ...
 * @version 1.0.1
 * Date: 28/09/16 às 14:41
 */

namespace Email\Notification\Controller\Access;
use Email\Entity\TraitEntityDataMail;
use Email\Template\AbstractThemeFactory;

class EmailEsqueceuSenha extends AbstractThemeFactory
{

    use TraitEntityDataMail;
    ...
    private function content()
    {
        ...
        $url_link = sprintf("%s/public/senha-redefinir/%s", VIALOJA_APP, $this->getHash());
				...
				<td bgcolor=\"#f7f7f7\">
					...
					<table width=\"600\" bgcolor=\"#f7f7f7\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\" align=\"center\" class=\"table\">
						...
						<tr>
							...
							<br />
							Olá <span style=\"font-weight:bold;\">{$this->getNome()}</span>, este email está sendo enviado pois alguém, possivelmente você, clicou no link \"esqueci a minha senha\".
							<br />
							<br />
    ...
    {
        return str_replace('%%%content%%%', $this->content(), parent::templateHTML($this->getLinkLoja()));
    }

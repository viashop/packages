 ...
 * @package Correios\Calculos\Http
 */

namespace Correios\Calculos\Http;
use Correios\Calculos\Http\HTTPAuthenticator as HTTPAuthenticator;
use Correios\Calculos\Http\HTTPRequestMethod as HTTPRequestMethod;
use Correios\Calculos\Http\CURL as CURL;

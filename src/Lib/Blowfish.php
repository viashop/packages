...
define('VL_UNPACK_NATIVE', 1);
define('VL_UNPACK_MODIFIED', 2);
...
class Crypt_Blowfish
{
	...
	protected $_unpackMode = VL_UNPACK_NATIVE;
	...
	function __construct($key, $iv)
	{
		...
		if (PHP_VERSION_ID == '50201' OR PHP_VERSION_ID == '50206')
			$this->_unpackMode = VL_UNPACK_MODIFIED;
	...
	function encrypt($plainText)
	{
		...
		for ($i = 0; $i < $len; $i += 8)
		{
			list(, $Xl, $Xr) = ($this->_unpackMode == VL_UNPACK_NATIVE ? unpack('N2', substr($plainText, $i, 8)) : $this->myUnpackN2(substr($plainText, $i, 8)));
	...
	function decrypt($cipherText)
	{
		...
		for ($i = 0; $i < $len; $i += 8)
		{
			list(, $Xl, $Xr) = ($this->_unpackMode == VL_UNPACK_NATIVE ? unpack('N2', substr($cipherText, $i, 8)) : $this->myUnpackN2(substr($cipherText, $i, 8)));
